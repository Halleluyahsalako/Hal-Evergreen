...
function HomePage() {
    ...
    return (
        <div className='home-parent'>
            ...
            <div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p>Don’t quit forex trading; join our community and enjoy the profit ride.</p>
                    </div>
            ...
            <div>
                <h2>Explore our <span>Features</span></h2>
                ...
                <div>
                    ...
                    <div>
                        <div>
                            <h3>Reliable AI</h3>
                            <p>Our carefully crafted AI helps you win at Forex irrespective of the market condition. 
                                You do not have to worry about learning how the forex market works. Become a star trader 
                    ...
                    <div>
                        <div>
                            ...
                            <p>While your money stays in your broker account, 
                                our AI has been designed to execute and close trades on your account. 
                                You do not have to worry about trading while carrying out your daily activities.
                            </p>
                        </div>
                        <main><img src={settings} alt="image" /></main>
                    </div>

                    <div>
                        <div>
                            <h3>All Round Security</h3>
                            <p>You do not have to worry about the safety of your funds as you are 
                                not required at any point in time to invest your capital with us. 
                                We also work hard to ensure that your data is safe and secure.
                            </p>
                        </div>
                        <main><img src={secure} alt="image" /></main>
                    </div>

                    <div>
                        <div>
                            <h3>24/7 Support</h3>
                            <p>Enjoy an always-accessible support team. We understand that our community may have occasional
                                support matters, this is why we have created a team to attend to the issues of our 
                                customers.
                            </p>
                        </div>
                    ...
                    <div>
                        <div>
                            ...
                            <p>With a concise data dashboard, monitor your trades and earnings, 
                                withdrawals, rankings, and referrals.
                            </p>
                        </div>
                        <main><img src={chart} alt="image" /></main>
                    </div>

                    <div>
                        <div>
                            <h3>Earn on referrals</h3>
                            <p>At EvergreenFFX, we like to appreciate our customers for the new connections created 
                                by them. Earn a 10% commission on all referrals. You stand a chance to earn as 
                                much as $30,000.
                            </p>
                        </div>
                        <main><img src={market} alt="image" /></main>
                    </div>
                </div>
            </div>
