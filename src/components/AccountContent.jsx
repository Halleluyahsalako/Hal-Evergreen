            ...
            <div className='email'>
                <div className='password'>
                    ...
                    <i style={{
                        ...
                        { seePass ? <FiEyeOff onClick={hidePassword} />
    ...
    const Wallet = () => {
        return (
            <div className='email wallet'>
                ...
                <input type="text" placeholder='Enter your USDT(TRC20) Wallet Address' />
                <div className='wallet-otp'>
                    <p>Please enter Generated OTP</p>
                    <input type="text" />
                </div>
                <main><img src={key} alt="image" /> <p>Tap to Generate OTP</p></main>
                <div style={{
